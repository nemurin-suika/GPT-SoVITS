...
class TTS:
    ...
    def set_prompt(self, prompt_text: str, prompt_lang: str):
        '''
            Pre-cache prompt text processing to skip recomputing on the first request.
            Args:
                prompt_text: str, already normalized prompt text for the reference audio.
